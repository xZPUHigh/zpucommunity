...
wait(4)
    print("Founder/ ZPU {xZPUHigh}")
        wait(4)
    print("Last Updated 04/03/24")
--[[
	WARNING: this just BETA PROJECT! This script has not been verified by QC. Use at your own risk!
]]
print("https://discord.gg/C3MpUNwsDU")
toclipboard("https://discord.gg/C3MpUNwsDU")
...
_G.Settings = {
	...
	ConfigsUI = {
		ColorUI = Color3.fromRGB(111, 0, 255), --{Color UI}
	}
}
-- [require module]
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("ZPU HUB Premium Scripts") then
			makefolder("ZPU HUB Premium Scripts")
		end
		if not isfolder("ZPU HUB Premium Scripts/Blox Fruits/") then
			makefolder("ZPU HUB Premium Scripts/Blox Fruits/")
		end
		if not isfile("ZPU HUB Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("ZPU HUB Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("ZPU HUB Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("ZPU HUB Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("ZPU HUB Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
